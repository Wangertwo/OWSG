...
public class GhostItem : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Disable collision between ghost and player
        if (ConstructionManager.Instance.playerCollider != null)
        {
            Collider playerCollider = ConstructionManager.Instance.playerCollider.GetComponent<Collider>();
